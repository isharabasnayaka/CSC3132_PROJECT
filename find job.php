...
<head>
  ...
  <link rel="stylesheet" href="css styles/findjob%20css.css">
</head>
<body class="bg-light">
    <!-----------------title bar------------>
    <section>
    ...
    <div class="card shadow-lg">
      ...
      <div class="card-body px-4 py-5">
        <form action="find job connection.php" method="POST" enctype="multipart/form-data">
          ...
          <input type="password" class="form-control" id="password" style="max-width: 360px;" placeholder="Enter your password" required>
          </div>
